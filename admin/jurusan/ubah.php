...
<head>
	...
	<title>Ubah Jurusan - UKM SAR UNIVERSITAS MALIKUSSALEH</title>
					...
					<div class="card-body">
						<form method="POST" action="proses_ubah.php?id=<?= $jurusan['id'] ?>">
							<div class="form-group">
								...
								<input type="text" value="<?= $jurusan['nama_jurusan'] ?>" class="form-control" id="nama_jurusan" placeholder="nama bidang" autocomplete="off" required="required" name="nama_jurusan">
							</div>
							<div class="form-group">
