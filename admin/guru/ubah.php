...
<head>
	...
	<title>Ubah Guru - UKM SAR UNIVERSITAS MALIKUSSALEH</title>
					...
					<div class="card-body">
						<form method="POST" action="proses_ubah.php?id=<?= $guru['id'] ?>" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col">
									<div class="form-group">
										<label for="mata_pelajaran">Devisi</label>
										<input type="text" value="<?= $guru['mata_pelajaran'] ?>" class="form-control" id="mata_pelajaran" placeholder="Devisi" autocomplete="off" required="required" name="mata_pelajaran">
									</div>
								</div>
							</div>
							<div class="form-group">
