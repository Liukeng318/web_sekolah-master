...
<head>
	...
	<title>Tambah Data Pengurus - UKM SAR UNIVERSITAS MALIKUSSALEH</title>
							...
							<div class="row">
								...
								<div class="col">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="mata_pelajaran" placeholder="Devisi" autocomplete="off" required="required" name="mata_pelajaran">
									</div>
								</div>
							</div>
							<div class="form-group">
