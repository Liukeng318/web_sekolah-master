...
$base_url = "http://localhost/web_sekolah-master/" 
?>
	...
	<div class="container">
		<ul class="navbar-nav">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="<?= $base_url ?>admin/guru/index.php">Data Pengurus</a>
					<a class="dropdown-item" href="<?= $base_url ?>admin/jurusan/index.php">Data Bidang</a>
					<a class="dropdown-item" href="<?= $base_url ?>admin/siswa/index.php">Data Pendiri</a>
					<a class="dropdown-item" href="<?= $base_url ?>admin/ekskul/index.php">Data Teras</a>
